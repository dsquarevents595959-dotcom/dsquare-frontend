    ...
    <footer className="bg-gray-900 text-gray-400 py-10 sm:py-12 border-t border-gray-800">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 sm:gap-10">
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">DSquareEvents</h3>
            <p className="text-sm">Dsquarevents is a professional event management service specializing in creating memorable celebrations and experiences.
We handle everything from planning to execution, including decorations, entertainment, and logistics.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['flower decorations', 'special entry', 'Corporate Events', 'Venue Decoration', 'Special Effects'].map((service) => (
                <li key={service}>
        ...
        <div className="mt-6 text-sm text-center">
          <div className="border-t-2 border-white pt-4">
            <p className="mb-2">&copy; {new Date().getFullYear()} DSquareEvents. All rights reserved.</p>
