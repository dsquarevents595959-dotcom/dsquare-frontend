...
const ScrollToTop = () => {
  ...
  return (
    <>
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/7032619629"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-20 right-8 z-50 p-4 bg-green-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-green-300"
